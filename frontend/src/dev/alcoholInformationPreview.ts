import type { AlcoholInformationResponseDto } from '../features/drinks/types/alcoholInformation'

export const ALCOHOL_INFORMATION_PREVIEW: AlcoholInformationResponseDto = {
  topics: [
    {
