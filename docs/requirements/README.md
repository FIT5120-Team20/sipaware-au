...
Epic 1 US1.4 drinking-history management, other unimplemented Epic 1 stories, and all Epic 2 functionality are intentionally excluded. Authentication is not currently in scope for Iteration 1 unless later requirements state otherwise. Future requirements must be recorded here without inferring product or data behaviour that has not been approved.
